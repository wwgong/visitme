...
<div class="textAlignCenter">
    <span class="warning">Your current city/town is not set yet. Your friend(s) will not be able to find you.</span> <br />
    <a href="http://www.facebook.com/profile.php?ref=profile&id={$uid1}#/profile.php?v=info&ref=profile&id={$uid1}" target="showframe">
        Please set your current city/town under "Info" tab, "Contact Information" section...
    </a>
</div>
<br />